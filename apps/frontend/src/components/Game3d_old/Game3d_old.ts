...
import { Game3dConnector, type Game3dMeshes } from './Game3dConnector_old';
import { loadBall, loadBackgroundSphere, loadCelebrationSphere, loadStadium, type StadiumMeshes , loadScoreboard, type ScoreboardMeshes, updateScoreTexture, createGoalCelebrationParticles, triggerGoalCelebration} from './AssetLoader_old';
